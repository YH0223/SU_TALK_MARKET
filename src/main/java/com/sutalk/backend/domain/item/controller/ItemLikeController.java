...
import com.sutalk.backend.domain.item.service.ItemLikeService;
...
public class ItemLikeController {
    ...
    // 특정 유저의 좋아요 목록
    @PostMapping("/my")
    public ResponseEntity<List<FavoriteItemDTO>> myFavorites(@RequestBody Map<String, String> body) {
